    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: 'Total Stock',     value: stats?.totalStock.toLocaleString() ?? '—',    icon: Package,       bg: 'from-[#E8315B] to-[#BA2749]',   shadow: 'shadow-[#E8315B]/20' },
            ...
            {analyticsLoading ? (
              ...
              <div className="divide-y divide-gray-50">
                {analytics.topProducts.map((p, i) => (
                  ...
                  >
                    <span className={`w-6 text-center text-sm font-bold ${i < 3 ? 'text-[#E8315B]' : 'text-gray-400'}`}>
                      {i + 1}
                    </span>
            ...
            {analyticsLoading ? (
              ...
              <div className="p-5 space-y-5">
                ...
                <div className="pt-3 border-t border-gray-100 grid grid-cols-3 text-center">
                  ...
                  <div>
                    <p className="text-lg font-black text-[#E8315B]">{stats?.totalProducts ?? '—'}</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] bg-gray-50/50 transition-all"
            />
          </div>
          ...
          <div className="w-full sm:w-44 relative">
            <select
              ...
              className="w-full px-4 py-2.5 pr-10 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] bg-gray-50/50 appearance-none cursor-pointer"
            >
              {typeOptions.map(opt => (
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-3 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] bg-gray-50/50 text-sm"
              />
            </div>
            ...
            <input
              ...
              className="px-3 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] bg-gray-50/50 text-sm"
            />
            {(startDate || endDate) && (
              <button
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="p-5 border-b border-gray-100 flex items-center justify-between">
            <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
              <History className="h-5 w-5 text-[#E8315B]" /> Stock Movements
            </h2>
              ...
              <tbody className="divide-y divide-gray-100">
                {loading ? (
                  <tr><td colSpan={7} className="px-6 py-12 text-center">
                    <Loader2 className="h-6 w-6 animate-spin text-[#E8315B] mx-auto" />
                  </td></tr>
                  ...
                  return (
                    <tr key={record._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <Link href={`/products/${record.product?._id}`} className="font-medium text-gray-900 hover:text-[#E8315B] transition-colors">
                ...
                {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                  ...
                  return (
                    <button key={pageNum} onClick={() => setPage(pageNum)}
                      className={`w-9 h-9 rounded-lg text-sm font-medium transition-colors ${pageNum === page ? 'bg-[#E8315B] text-white' : 'border border-gray-200 hover:bg-gray-50 text-gray-700'}`}>
                      {pageNum}
                    </button>
                  );
                })}
