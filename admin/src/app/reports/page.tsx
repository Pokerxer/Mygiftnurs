  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        type="button"
        onClick={() => setOpen(o => !o)}
        className="flex items-center gap-2 h-9 px-3 rounded-xl border border-gray-200 bg-white text-sm hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#E8315B] min-w-[168px] transition-colors"
      >
          ...
          {options.map(opt => {
            ...
            return (
              ...
              >
                ...
                {active && <span className="text-[#E8315B] text-xs font-bold">✓</span>}
              </button>
            );
          })}
        </div>
  ...
  return (
    <div className="relative mb-4 max-w-xs">
      ...
      <input
        ...
        placeholder="Search…"
        className="w-full pl-9 pr-4 h-9 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#E8315B]"
      />
    </div>
  );
}
          ...
          <div className="flex flex-wrap items-end gap-3">
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="h-9 px-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#E8315B]"
                  />
                </div>
                <div>
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold bg-[#E8315B] text-white hover:bg-[#b8933e] transition-colors disabled:opacity-60"
              >
                {loading
        ...
        <AnimatePresence mode="wait">
          {error && (
            ...
            >
              ...
              <button onClick={() => generate()} className="text-sm text-[#E8315B] hover:underline">Retry</button>
            </motion.div>
          )}
        </AnimatePresence>
