              ...
              <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg z-20 py-1 min-w-[150px]">
                {STATUSES.map(s => (
                  <button
                    ...
                    className={`w-full text-left flex items-center gap-2 px-4 py-2 text-sm hover:bg-gray-50 ${fullOrder.status === s ? 'font-semibold text-[#E8315B]' : 'text-gray-700'}`}
                  >
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="flex items-center gap-1.5 flex-1">
                ...
                <input type="date" value={startDate} onChange={e => setStartDate(e.target.value)}
                  className="flex-1 min-w-0 px-2 py-1.5 text-xs border border-gray-200 rounded-lg focus:outline-none focus:border-[#E8315B] bg-gray-50" />
            ...
            {loading ? (
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-5 py-4 transition-colors hover:bg-gray-50 ${isSelected ? 'bg-amber-50/60 border-l-2 border-[#E8315B]' : ''}`}
                >
