...
function ReviewCard({ review, onDelete }: { review: Review; onDelete: (id: string) => void }) {
  ...
  return (
    <div className="group bg-white rounded-2xl border border-gray-100 p-5 hover:shadow-lg hover:border-[#E8315B]/20 transition-all duration-300">
      <div className="flex items-start gap-5">
        ...
        <Link href={`/products/${review.product?._id}`} className="flex-shrink-0 group-image">
          {review.product?.images?.[0]?.url ? (
            <img
              ...
              className="w-20 h-20 rounded-2xl object-cover ring-2 ring-gray-100 group-hover:ring-[#E8315B]/30 transition-all"
            />
          ) : (
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between gap-3 mb-2">
            <div>
              <Link href={`/products/${review.product?._id}`} className="font-bold text-gray-900 hover:text-[#E8315B] transition-colors line-clamp-1">
          ...
          <div className="flex items-center gap-2 mb-3">
            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#E8315B] to-[#BA2749] flex items-center justify-center">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              ...
              {isLongComment && (
                <button
                  ...
                  className="text-[#E8315B] text-xs font-medium ml-1.5 hover:underline"
                >
  ...
  if (error) return (
    <AdminLayout>
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
        ...
        <button 
          onClick={load} 
          className="px-5 py-2.5 bg-[#E8315B] text-white rounded-xl text-sm font-medium hover:bg-[#BA2749] hover:shadow-lg hover:shadow-[#E8315B]/20 transition-all"
        >
          Try Again
        </button>
      </div>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#E8315B] to-[#BA2749] flex items-center justify-center shadow-lg">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#E8315B] focus:ring-2 focus:ring-[#E8315B]/10 transition-all"
              />
            </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border transition-all ${
                showFilters || ratingFilter 
                  ? 'border-[#E8315B] bg-amber-50 text-[#E8315B]' 
            ...
            >
              ...
              {ratingFilter && (
                <span className="w-5 h-5 rounded-full bg-[#E8315B] text-white text-[10px] flex items-center justify-center">
                  {ratingFilter}
                </span>
              )}
            </button>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${
                      ratingFilter === opt.value
                        ? 'bg-[#E8315B] text-white shadow-lg shadow-[#E8315B]/20'
        ...
        {reviews.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-16 text-center">
            ...
            {hasActiveFilters && (
              <button
                onClick={clearFilters}
                className="mt-4 px-4 py-2 bg-[#E8315B] text-white rounded-xl text-sm font-medium hover:bg-[#BA2749]"
              >
                Clear Filters
              </button>
            )}
