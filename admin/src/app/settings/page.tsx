...
export default function SettingsPage() {
  ...
  const [storeSettings, setStoreSettings] = useState({
    storeName: 'MyGiftNurs', storeUrl: 'https://mygiftnursemporium.com', currency: 'NGN',
    timezone: 'Africa/Lagos', email: 'info@mygiftnursemporium.com', phone: '07081856411',
  });
          ...
          <nav className="flex lg:flex-col gap-2 lg:space-y-1 overflow-x-auto lg:overflow-visible pb-2">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === tab.id ? 'bg-[#E8315B]/10 text-[#E8315B]' : 'text-gray-600 hover:bg-gray-50'}`}
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-300 p-2.5 text-sm focus:ring-2 focus:ring-[#E8315B] focus:border-transparent outline-none"
                    />
                  </div>
                  <div>
              ...
              {paymentSettings.codEnabled && (
                <div className="pl-14">
                  ...
                  <input
                    ...
                    className="w-full md:w-48 rounded-lg border border-gray-300 p-2.5 text-sm focus:ring-2 focus:ring-[#E8315B] focus:border-transparent outline-none"
                  />
                </div>
              )}
            </div>
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full md:w-32 rounded-lg border border-gray-300 p-2.5 text-sm focus:ring-2 focus:ring-[#E8315B] focus:border-transparent outline-none"
                    />
                    ...
                    <div className="rounded-lg border p-4">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full rounded-lg border border-gray-300 p-2 pl-8 text-sm focus:ring-2 focus:ring-[#E8315B] focus:border-transparent outline-none"
                        />
                      </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-t pt-6">
            ...
            <div className="sm:ml-auto">
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-[#E8315B] px-4 py-2 text-sm font-medium text-white hover:bg-[#BA2749] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
