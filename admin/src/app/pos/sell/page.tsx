    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-5 space-y-5">
          ...
          {matched && (
            <div className={`flex items-center justify-between px-4 py-3 rounded-xl border ${canAdd ? 'border-[#E8315B]/40 bg-amber-50/60' : 'border-red-100 bg-red-50/60'}`}>
          ...
          <button onClick={() => canAdd && onSelect(matchedIdx)} disabled={!canAdd} className={`w-full py-3 rounded-xl text-sm font-bold transition-all ${canAdd ? 'bg-gray-900 text-white hover:bg-[#E8315B] hover:shadow-lg hover:shadow-[#E8315B]/20' : 'bg-gray-100 text-gray-400 cursor-not-allowed'}`}>{canAdd ? 'Add to Cart' : 'Out of Stock'}</button>
        </div>
      </div>
    </div>
  );
      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center gap-1.5 py-3 rounded-xl border-2 text-sm font-medium transition ${
                      paymentMethod === m
                        ? 'border-[#E8315B] bg-amber-50 text-amber-700'
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  placeholder="0"
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-[#E8315B]"
                />
              </div>
              <button
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="text-xs font-medium text-[#E8315B] hover:text-[#b8973e] flex items-center gap-1"
                >
        ...
        <div className="px-5 py-4 border-t flex gap-3">
          ...
          <button
            ...
            className="flex-2 flex-grow py-3 bg-[#E8315B] hover:bg-[#b8973e] text-white rounded-xl text-sm font-bold disabled:opacity-50 transition"
          >
...
function ReceiptModal({ sale, onClose, onNewSale }: { sale: Sale; onClose: () => void; onNewSale: () => void }) {
  ...
  function print() {
    ...
    const html = `
      ...
      <head>
        ...
        <style>
          * { margin:0; padding:0; box-sizing:border-box; }
          ...
          .logo-circle { width:36px; height:36px; border-radius:10px; background:#E8315B; display:flex; align-items:center; justify-content:center; flex-shrink:0; overflow:hidden; }
          ...
          .footer .ty { font-size:11px; font-weight:600; color:#E8315B; letter-spacing:0.5px; }
      ...
      <body>
        <div class="logo-wrap">
          <div class="logo-circle"><img src="${logoUrl}" alt="MyGiftNurs" onerror="this.style.display='none'"></div>
          <span class="brand">MyGiftNurs</span>
        </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl w-full max-w-xs shadow-2xl overflow-hidden">
          ...
          <div id="receipt" className="px-5 py-5 space-y-4 font-[system-ui]">
            ...
            <div className="text-center space-y-1">
              <div className="flex items-center justify-center gap-2 mb-2">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#E8315B] to-[#BA2749] flex items-center justify-center shadow-md overflow-hidden flex-shrink-0">
                  <img src="/logo.png" alt="MyGiftNurs" className="w-full h-full object-contain p-0.5" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
                </div>
                <span className="text-2xl font-black tracking-widest text-gray-900">MyGiftNurs</span>
              </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between items-center font-black text-base border-t-2 border-gray-900 pt-2 mt-1">
                <span>TOTAL</span>
                <span className="text-[#E8315B]">{formatPrice(sale.total)}</span>
              </div>
              <div className="flex justify-between text-gray-500 text-xs">
            ...
            {/* Footer */}
            <div className="text-center space-y-1">
              <p className="text-xs font-semibold text-[#E8315B] tracking-wide">Thank you for shopping with us!</p>
        ...
        <div className="px-5 py-4 border-t flex gap-3 bg-gray-50">
          ...
          <button
            onClick={onNewSale}
            className="flex-1 py-2.5 bg-[#E8315B] hover:bg-[#BA2749] text-white rounded-xl text-sm font-bold transition shadow-md shadow-[#E8315B]/20"
          >
            New Sale
          </button>
        </div>
    ...
    <div className="h-screen flex flex-col bg-gray-100 overflow-hidden">
      ...
      <header className="bg-gray-900 text-white px-4 py-3 flex items-center justify-between flex-shrink-0 shadow-lg z-20">
        <div className="flex items-center gap-3">
          ...
          <div className="w-8 h-8 rounded-lg bg-[#E8315B] flex items-center justify-center">
            <LayoutGrid className="w-4 h-4 text-white" />
          </div>
          <div>
            <p className="font-bold text-sm leading-none">MyGiftNurs</p>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-lg">
            <div className="w-5 h-5 rounded-full bg-[#E8315B] flex items-center justify-center text-xs font-bold">
      ...
      <div className="lg:hidden flex bg-white border-b">
        <button
          ...
          className={`flex-1 py-2.5 text-sm font-medium flex items-center justify-center gap-2 transition ${mobileView === 'cart' ? 'text-[#E8315B] border-b-2 border-[#E8315B]' : 'text-gray-500'}`}
        >
          <ShoppingCart className="w-4 h-4" /> Cart
          {cart.length > 0 && (
            <span className="w-5 h-5 bg-[#E8315B] text-white text-xs rounded-full flex items-center justify-center">{cart.length}</span>
          )}
        </button>
        <button
          onClick={() => setMobileView('products')}
          className={`flex-1 py-2.5 text-sm font-medium flex items-center justify-center gap-2 transition ${mobileView === 'products' ? 'text-[#E8315B] border-b-2 border-[#E8315B]' : 'text-gray-500'}`}
        >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className={`${mobileView === 'cart' ? 'flex' : 'hidden'} lg:flex flex-col w-full lg:w-80 xl:w-[360px] bg-white border-r border-gray-200 flex-shrink-0 overflow-hidden`}>
          ...
          {carts.length > 0 && (
            <div className="flex items-center gap-1 px-2 py-1.5 border-b overflow-x-auto scrollbar-hide bg-gray-50">
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 px-2.5 py-1.5 rounded-lg text-xs font-medium transition flex items-center gap-1.5 ${
                      isActive
                        ...
                        : 'bg-white text-gray-600 border border-gray-200 hover:border-[#E8315B]'
                    }`}
                  >
              ...
              <button
                ...
                className="flex-shrink-0 p-1.5 rounded-lg text-gray-400 hover:text-[#E8315B] hover:bg-[#E8315B]/10 transition"
                title="New Order"
              >
          ...
          <div className="px-3 py-2.5 border-b flex items-center gap-2">
            <ShoppingCart className="w-4 h-4 text-[#E8315B] flex-shrink-0" />
                ...
                {cart.map((item, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`px-4 py-3 cursor-pointer transition border-b border-gray-100 last:border-b-0 ${isSelected ? 'bg-[#E8315B]/5 outline outline-2 outline-[#E8315B] outline-offset-[-2px] rounded-sm' : 'hover:bg-gray-50'}`}
                    >
                      {/* Row 1: name + total */}
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        <span className={`border rounded px-2 py-0.5 text-sm font-semibold min-w-[48px] text-center ${
                          isSelected && numpadMode === 'qty'
                            ? 'border-[#E8315B] bg-white text-[#E8315B] ring-1 ring-[#E8315B]/30'
          ...
          <div className="border-t flex items-stretch bg-white flex-shrink-0">
            ...
            >
              {customer ? <span className="text-[#E8315B] truncate max-w-[80px] block">{customer.name}</span> : <span className="text-gray-700">Customer</span>}
            </button>
            <input
              type="text"
            ...
            <div className="border-t bg-white flex-shrink-0">
              ...
              <div className="flex items-center justify-between px-4 py-2 bg-gray-50 border-b border-gray-100">
                ...
                <span className="font-mono text-lg font-bold text-gray-900">
                  {numpadInput !== '' ? (
                    <>{numpadInput}<span className="text-[#E8315B] animate-pulse">|</span></>
                  ) : numpadMode === 'qty' ? (
                  ...
                  return (
                    <button
                      ...
                      className={`py-3.5 text-sm font-semibold border-b border-r border-gray-100 last:border-r-0 transition active:scale-95 ${
                        ...
                        isModeActive      ? 'bg-[#E8315B] text-white' :
          ...
          <button
            ...
            className="w-full py-4 bg-[#E8315B] hover:bg-[#BA2749] text-white font-bold text-base transition disabled:opacity-40 flex-shrink-0 flex items-center justify-center gap-3 shadow-lg shadow-[#E8315B]/20"
          >
            {processing ? (
          ...
          <div className="bg-white border-b px-4 py-3 space-y-3 flex-shrink-0">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-10 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#E8315B] bg-gray-50"
                    ...
                    <div
                      ...
                      className={`relative bg-white rounded-2xl border-2 text-left overflow-hidden transition group ${
                        outOfStock
                          ...
                          : inCart > 0
                            ? 'cursor-pointer border-[#E8315B] shadow-md'
                            : 'cursor-pointer border-gray-100 hover:border-[#E8315B] hover:shadow-md'
                      }`}
                    >
                      {/* Favorite button */}
                      <button
                      ...
                      {inCart > 0 && (
                        <div className="absolute top-2 right-2 z-10 w-5 h-5 bg-[#E8315B] rounded-full flex items-center justify-center text-white text-xs font-bold">
                          {inCart}
                        </div>
                      )}
                      ...
                      <div className="p-2.5">
                        ...
                        <p className="text-xs font-bold text-[#E8315B] mt-1">{formatPrice(minPrice)}</p>
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-5 border-b">
              <div className="flex items-center gap-3 mb-1">
                <div className="w-10 h-10 rounded-xl bg-[#E8315B]/10 flex items-center justify-center">
                  <DollarSign className="w-5 h-5 text-[#E8315B]" />
                </div>
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="0.00"
                  autoFocus
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-lg font-semibold focus:outline-none focus:border-[#E8315B]"
                />
              ...
              <button
                ...
                className="w-full py-3 bg-[#E8315B] hover:bg-[#b8963e] text-white rounded-xl font-semibold text-sm transition"
              >
                Open Register
              </button>
            </div>
          ...
          <div className="relative w-72 bg-gray-900 text-white h-full flex flex-col shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-5 py-6 border-b border-white/10">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[#E8315B] flex items-center justify-center font-bold text-lg">
                  {user?.name.charAt(0).toUpperCase()}
                </div>
                <div>
            ...
            <nav className="flex-1 p-3 space-y-1">
              {[
                {
                  icon: <LayoutGrid className="w-5 h-5 text-[#E8315B]" />,
                  label: 'Dashboard',
                  sub: 'Sessions & stats',
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 bg-[#E8315B] hover:bg-[#b8963e] disabled:opacity-50 text-white rounded-xl text-sm font-semibold transition"
                >
              ...
              <div className="p-5 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    autoFocus
                    className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-xl font-bold focus:outline-none focus:border-[#E8315B]"
                  />
                </div>
                {countedCash !== '' && (
