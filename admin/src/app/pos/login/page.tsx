    ...
    <div className="min-h-screen bg-gray-950 flex flex-col select-none">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-bold text-sm leading-none">MyGiftNurs</p>
          ...
          <div className="w-full max-w-2xl">
            ...
            {loadingStaff ? (
              <div className="flex justify-center py-16">
                <Loader2 className="w-8 h-8 text-[#E8315B] animate-spin" />
              </div>
            ) : staff.length === 0 ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {staff.map(s => (
                  <button
                    ...
                    className="group flex flex-col items-center gap-3 p-6 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#E8315B]/50 rounded-2xl transition-all duration-150 active:scale-95"
                  >
                    {/* Avatar */}
                    {s.avatar ? (
                      <img src={s.avatar} alt={s.name} className="w-16 h-16 rounded-full object-cover ring-2 ring-white/10 group-hover:ring-[#E8315B]/50" />
                    ) : (
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#E8315B] to-amber-600 flex items-center justify-center ring-2 ring-white/10 group-hover:ring-[#E8315B]/50">
          ...
          <div className="w-full max-w-xs">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div className="flex items-center gap-3">
                {selected.avatar ? (
                  ...
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#E8315B] to-amber-600 flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex items-center justify-center gap-2 mb-6 min-h-[20px]">
              {pin.length === 0 ? (
                ...
                Array.from({ length: pin.length }).map((_, i) => (
                  <div key={i} className="w-2.5 h-2.5 rounded-full bg-[#E8315B]" />
                ))
              )}
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <button
                ...
                className="h-14 rounded-2xl bg-[#E8315B] hover:bg-[#b8933e] active:bg-[#a8832e] text-white font-bold transition-all active:scale-95 disabled:opacity-40 flex items-center justify-center"
              >
                {submitting
