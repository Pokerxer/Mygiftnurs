        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden print:shadow-none print:border-0">
          <div className="p-6 space-y-5">
            ...
            <div className="text-center border-b pb-5">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#E8315B] mb-3">
                <ShoppingBag className="w-6 h-6 text-white" />
              </div>
              <h2 className="text-2xl font-black tracking-tight">MyGiftNurs</h2>
            ...
            <div className="border-t pt-4 text-center space-y-1">
              ...
              <p className="text-xs text-gray-300 mt-3">Thank you for shopping at MyGiftNurs!</p>
            </div>
          </div>
        </div>
      </div>
