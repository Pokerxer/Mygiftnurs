...
function OrderDetail({
    ...
    const html = `
      ...
      <body>
        ...
        <div class="footer">
          ...
          <div style="margin-top: 4px;">Thank you for shopping at MyGiftNurs!</div>
        </div>
      </body>
      </html>
    `;
  ...
  function printInvoice() {
    ...
    w.document.write(`<html><head><title>Invoice ${sale.receiptNumber}</title><style>
      ...
      <div class="header">
        <div><h1>MyGiftNurs</h1><div style="color:#666;margin-top:4px">Tax Invoice</div></div>
      ...
      <div class="footer"><p>Thank you for shopping at MyGiftNurs!</p></div>
    </body></html>`);
    w.document.close();
    w.print();
  }
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div ref={printRef} style={{ display: 'none' }}>
        ...
        <p className="center">Thank you for shopping at MyGiftNurs!</p>
      </div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-40 text-gray-400">
                ...
                {(search || dateFilter || statusFilter) && (
                  <button onClick={() => { setSearch(''); setSearchInput(''); setDateFilter(''); setStatusFilter(''); }} className="text-xs text-[#E8315B] mt-1">Clear filters</button>
                )}
              </div>
            ) : (
