  ...
  if (!session) {
    return (
      <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
        ...
        <button
          onClick={onOpen}
          className="w-full mt-3 py-2.5 bg-[#E8315B] hover:bg-[#b8963e] text-white rounded-xl text-sm font-semibold transition flex items-center justify-center gap-2"
        >
    ...
    <div className={`bg-white rounded-2xl border shadow-sm overflow-hidden ${isOpen ? 'border-green-200' : 'border-gray-200'}`}>
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          ...
          <div className="bg-gray-50 rounded-xl py-2 px-1">
            <p className="text-base font-black text-[#E8315B] truncate">{formatPrice(revenue)}</p>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-gray-900 text-white px-4 sm:px-6 py-4 flex items-center justify-between shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div className="w-9 h-9 rounded-xl bg-[#E8315B] flex items-center justify-center">
            <LayoutGrid className="w-5 h-5 text-white" />
          </div>
          <div>
            <p className="font-black text-base leading-none">MyGiftNurs</p>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-lg">
            <div className="w-6 h-6 rounded-full bg-[#E8315B] flex items-center justify-center text-xs font-bold">
        ...
        <div className="flex flex-wrap gap-3">
          {currentSession ? (
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-[#E8315B] hover:bg-[#b8963e] text-white rounded-xl text-sm font-semibold transition shadow-sm"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
              ...
              <Link href="/pos/sales" className="text-xs text-[#E8315B] font-semibold flex items-center gap-1 hover:underline">
                  ...
                  return (
                    <div key={label}>
                      ...
                      <div className="w-full bg-gray-100 rounded-full h-1.5">
                        <div
                          className="h-1.5 rounded-full bg-[#E8315B] transition-all"
                          style={{ width: `${pct}%` }}
                        />
                      </div>
                    </div>
                  ...
                  {sessions.map(session => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 py-3 font-bold text-[#E8315B]">{formatPrice(revenue)}</td>
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 bg-[#E8315B] hover:bg-[#b8963e] disabled:opacity-50 text-white rounded-xl text-sm font-bold transition flex items-center justify-center gap-2"
                >
