      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 animate-fade-in">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center gap-3">
            <span className="w-2 h-8 bg-[#E8315B] rounded-full"></span>
            Import Products
          </h1>
        ...
        {!file && (
          <div
            className={`bg-white rounded-2xl border-2 border-dashed p-12 text-center transition-all cursor-pointer ${
              dragActive ? 'border-[#E8315B] bg-[#E8315B]/5' : 'border-gray-200 hover:border-[#E8315B]/50'
            }`}
          ...
          >
            ...
            <div className="flex flex-col items-center">
              <div className="h-16 w-16 rounded-2xl bg-[#E8315B]/10 flex items-center justify-center mb-4">
                <Upload className="h-8 w-8 text-[#E8315B]" />
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
              <div className="p-4 border-b flex items-center justify-between">
                ...
                {parsing ? (
                  ...
                  <button onClick={() => parseFile(file)} className="flex items-center gap-2 text-sm text-[#E8315B] hover:bg-[#E8315B]/5 px-3 py-1.5 rounded-lg">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-[#E8315B] text-white rounded-xl font-medium hover:bg-[#BA2749] disabled:opacity-50"
              >
                {importing ? (
        ...
        {importResult && (
          <div className="bg-white rounded-2xl border border-gray-100 p-8 animate-slide-up">
            ...
            <button
              onClick={handleReset}
              className="flex items-center gap-2 px-6 py-2.5 bg-[#E8315B] text-white rounded-xl font-medium hover:bg-[#BA2749]"
            >
          ...
          <div className="mt-6 bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-[#E8315B] hover:bg-[#E8315B]/5 rounded-lg text-sm font-medium"
              >
