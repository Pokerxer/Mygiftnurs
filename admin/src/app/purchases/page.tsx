    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#E8315B] to-[#BA2749] flex items-center justify-center mb-3 shadow-md shadow-[#E8315B]/20">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h2 className="font-semibold text-gray-900 flex items-center gap-2">
              <ShoppingBag className="h-5 w-5 text-[#E8315B]" />
              Purchase Orders
            </h2>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            <Link
                              ...
                              className="text-sm text-[#E8315B] hover:underline font-medium"
                            >
                              View
                            </Link>
