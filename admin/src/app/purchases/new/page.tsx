                ...
                <div key={i} className={`grid grid-cols-[1fr_90px_110px_90px] gap-3 items-center px-6 py-3.5 transition-colors ${row.quantity > 0 ? 'bg-amber-50/40' : ''}`}>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm text-center focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] transition-colors"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <input
                      ...
                      className="w-12 text-center py-1.5 border border-gray-200 rounded-lg text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] transition-colors"
                    />
                    <button
                      type="button"
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between gap-4 bg-gray-50 rounded-b-2xl">
          ...
          <div className="flex gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#E8315B] text-white rounded-xl text-sm font-semibold hover:bg-[#BA2749] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
        ...
        <div className="space-y-6">
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" value={supplier} onChange={e => setSupplier(e.target.value)}
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] transition-all"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">
            ...
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between gap-4">
              ...
              <div ref={searchRef} className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 bg-[#E8315B] text-white rounded-xl text-sm font-semibold hover:bg-[#BA2749] transition-colors shadow-sm shadow-[#E8315B]/20"
                >
                    ...
                    <div className="p-3 border-b border-gray-100">
                      <div className="relative">
                        ...
                        <input autoFocus type="text" value={searchQuery} onChange={e => setSearchQuery(e.target.value)}
                          ...
                          className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B]"
                        />
                      </div>
                    </div>
                      ...
                      <div className="flex items-center gap-4 px-6 py-4 bg-gray-50/60">
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 px-2.5 py-1.5 text-xs text-[#E8315B] border border-[#E8315B]/30 rounded-lg hover:bg-[#E8315B]/5 transition-colors font-medium"
                          >
                              ...
                              >
                                ...
                                <div className="relative">
                                  ...
                                  <input type="number" min="0" step="0.01"
                                    ...
                                    className="w-full pl-6 pr-2 py-2 border border-gray-200 rounded-lg text-sm text-right focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] transition-colors"
                                  />
                                </div>
                                ...
                                <div className="flex items-center gap-1 justify-center">
                                  ...
                                  <input type="number" min="1"
                                    ...
                                    className="w-14 text-center py-2 border border-gray-200 rounded-lg text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#E8315B]/20 focus:border-[#E8315B] transition-colors"
                                  />
                                  <button
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div className="flex gap-3 p-4 border border-[#E8315B] bg-[#E8315B]/5 rounded-xl">
                <CheckCircle className="w-5 h-5 text-[#E8315B] flex-shrink-0 mt-0.5" />
                <div>
          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => handleSubmit(true)} disabled={saving}
                className="flex items-center gap-2 px-6 py-2.5 bg-[#E8315B] text-white rounded-xl text-sm font-semibold hover:bg-[#BA2749] disabled:opacity-50 transition-colors shadow-lg shadow-[#E8315B]/20"
              >
