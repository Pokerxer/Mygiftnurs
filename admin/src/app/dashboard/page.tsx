...
const CATEGORY_COLORS = [
  'bg-[#E8315B]', 'bg-indigo-500', 'bg-emerald-500',
    ...
    <div className="flex items-center gap-3 py-1.5">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 h-1.5 bg-gray-100 rounded-full overflow-hidden">
            <div
              className="h-full bg-[#E8315B] rounded-full transition-all duration-500"
              style={{ width: `${pct}%` }}
            />
          </div>
  ...
  if (error) return (
    <AdminLayout>
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
        ...
        <button
          onClick={() => load(period)}
          className="px-4 py-2 bg-[#E8315B] text-white rounded-xl text-sm font-medium hover:bg-[#b8933e] transition-colors"
        >
          Retry
        </button>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <ResponsiveContainer width="100%" height={220}>
              {trendChart === 'area' ? (
                <AreaChart data={data!.trend} margin={{ top: 4, right: 4, left: -16, bottom: 0 }}>
                  <defs>
                    ...
                    <linearGradient id="gradPos" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%"  stopColor="#E8315B" stopOpacity={0.25} />
                      <stop offset="95%" stopColor="#E8315B" stopOpacity={0} />
                    </linearGradient>
                  </defs>
                  ...
                  <Area type="monotone" dataKey="pos" name="POS" stackId="rev" stroke="#E8315B" strokeWidth={2} fill="url(#gradPos)" dot={false} activeDot={{ r: 4, strokeWidth: 0 }} />
                </AreaChart>
              ) : (
                <BarChart data={data!.trend} margin={{ top: 4, right: 4, left: -16, bottom: 0 }}>
                  ...
                  <Bar dataKey="pos" name="POS" stackId="rev" fill="#E8315B" radius={[3, 3, 0, 0]} />
                </BarChart>
              )}
            </ResponsiveContainer>
            <div className="flex items-center gap-4 mt-3">
              ...
              <span className="flex items-center gap-1.5 text-xs text-gray-500">
                <span className="w-3 h-2 bg-[#E8315B] rounded-sm inline-block" />
                POS Sales
              </span>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <div className="flex justify-between text-xs mb-1.5">
                    <span className="text-gray-500 flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-[#E8315B] inline-block" />
                      POS Sales
                    </span>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {selectedStatus && (
                  <button 
                    ...
                    className="text-[10px] text-[#E8315B] hover:underline"
                  >
                    Clear filter
                  </button>
                )}
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="/orders" className="text-[10px] text-gray-400 hover:text-[#E8315B] flex items-center gap-1">
