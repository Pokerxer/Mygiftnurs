        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#E8315B]/40 focus:border-[#E8315B]"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#E8315B]/40 focus:border-[#E8315B] resize-none"
              ...
              <div className="flex items-end pb-0.5">
                <label className="flex items-center gap-2 cursor-pointer select-none">
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${form.active ? 'bg-[#E8315B]' : 'bg-gray-200'}`}
                  >
          ...
          <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#E8315B] hover:bg-[#b8963e] disabled:opacity-50 text-white text-sm font-medium transition-colors"
            >
    ...
    <AdminLayout>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#E8315B] hover:bg-[#b8963e] text-white text-sm font-semibold transition-colors"
        >
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 p-16 text-center">
          <div className="w-14 h-14 bg-amber-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <Megaphone className="h-7 w-7 text-[#E8315B]" />
          </div>
          ...
          <button
            onClick={() => setModal({ ...EMPTY })}
            className="px-5 py-2.5 rounded-xl bg-[#E8315B] hover:bg-[#b8963e] text-white text-sm font-semibold transition-colors"
          >
            ...
            return (
              <div key={item._id} className={`rounded-2xl border p-5 flex items-start gap-4 transition-opacity ${item.active ? '' : 'opacity-60'}`}>
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  >
                    {item.active ? <ToggleRight className="h-5 w-5 text-[#E8315B]" /> : <ToggleLeft className="h-5 w-5" />}
                  </button>
                  <button
