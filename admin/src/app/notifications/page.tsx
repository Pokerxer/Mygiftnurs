        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {!notification.isRead && (
                <span className="inline-block w-2 h-2 rounded-full bg-[#E8315B] flex-shrink-0 animate-pulse" />
              )}
            </div>
      ...
      <div className="max-w-3xl mx-auto space-y-6">
            ...
            return (
              <button
                ...
                className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 ${
                  filter === tab.key
                    ? 'bg-gradient-to-r from-[#E8315B] to-[#BA2749] text-white shadow-lg shadow-[#E8315B]/20'
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-4 bg-white rounded-2xl border border-gray-100">
            ...
            {filter !== 'all' && (
              <button
                ...
                className="px-5 py-2.5 bg-[#E8315B] text-white rounded-xl text-sm font-semibold hover:bg-[#BA2749] transition-all"
              >
            ...
            {groups.map(group => (
              <div key={group.label}>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 px-1 flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#E8315B]" />
                  {group.label}
                </p>
                <div className="space-y-3">
        ...
        {filtered.length > 0 && (
          <p className="text-center text-xs text-gray-400 mt-8 pb-4">
            ...
            {filter !== 'all' && ` · `}
            {filter !== 'all' && (
              <button onClick={() => setFilter('all')} className="hover:text-[#E8315B] underline">
