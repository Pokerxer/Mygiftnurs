  ...
  return (
    <div ref={containerRef} className="relative w-full max-w-md">
      ...
      <input
        ...
        className="h-10 w-full rounded-lg border bg-gray-50 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#E8315B] focus:bg-white transition"
      />
      {loading && (
                ...
                <div>
                  <div className="flex items-center justify-between px-4 py-2 bg-gray-50">
                    ...
                    <button
                      ...
                      className="text-xs text-[#E8315B] hover:underline"
                    >
                      View all
                    </button>
                  </div>
                ...
                <div>
                  ...
                  {results.orders.map(o => (
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 text-left transition-colors"
                    >
                      <div className="h-8 w-8 rounded-lg bg-brand-pink-light flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  {results.customers.map(c => (
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 text-left transition-colors"
                    >
                      <div className="h-8 w-8 rounded-full bg-[#E8315B]/10 flex items-center justify-center flex-shrink-0">
                        <span className="text-xs font-semibold text-[#E8315B]">
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-2 md:gap-4 border-b bg-white px-2 md:px-6">
      ...
      <div className="relative">
        ...
        >
          <div className="h-8 w-8 rounded-full bg-[#E8315B] flex items-center justify-center">
            {user?.avatar ? (
          ...
          <div className="hidden md:block text-left">
            ...
            <p className="text-xs text-gray-500">{user?.email || 'admin@mygiftnurs.com'}</p>
          </div>
        ...
        {showDropdown && (
          <div className="absolute right-0 top-full mt-2 w-56 rounded-lg border bg-white py-1 shadow-lg z-50">
            <div className="md:hidden px-4 py-2 border-b">
              ...
              <p className="text-sm text-gray-500">{user?.email || 'admin@mygiftnurs.com'}</p>
            </div>
            <button
              onClick={() => {
