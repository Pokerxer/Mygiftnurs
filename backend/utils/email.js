...
async function sendEmail(to, subject, html) {
  ...
  const from = process.env.EMAIL_FROM || 'MyGiftNurs <noreply@mygiftnursemporium.com>';
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td style="padding:28px 40px 24px;text-align:center;">
              ...
              <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:32px;font-weight:900;letter-spacing:8px;color:${GOLD};text-transform:uppercase;line-height:1;">MYGIFTNURS</div>
          ...
          <tr>
            <td style="padding:28px 40px;text-align:center;">
              ...
              <p style="margin:0 0 16px;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;">
                <a href="mailto:hello@mygiftnursemporium.com" style="color:${GOLD};text-decoration:none;font-weight:600;">hello@mygiftnursemporium.com</a>
              </p>
              <p style="margin:0;font-family:'Helvetica Neue',Arial,sans-serif;font-size:11px;color:rgba(255,255,255,0.25);letter-spacing:0.5px;">
                &copy; ${new Date().getFullYear()} MyGiftNurs &nbsp;&middot;&nbsp; All rights reserved
              </p>
            </td>
          </tr>
        </table>
  ...
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:28px;">
    <tr>
      <td bgcolor="${OFFWHITE}" style="padding:20px 24px;border:1px solid ${BORDER};border-top:3px solid ${GOLD};border-radius:0 0 4px 4px;">
        ...
        <p style="margin:0;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;color:${MUTED};">Reply to this email or write to us at <a href="mailto:hello@mygiftnursemporium.com" style="color:${GOLD};font-weight:600;text-decoration:none;">hello@mygiftnursemporium.com</a></p>
      </td>
    </tr>
  </table>`;
}
...
function getOrderEmailHtml(order, user) {
  ...
  return layout(
    ...
    `Your MyGiftNurs order is confirmed and being prepared for dispatch.`,
    bodyHtml,
    '#0F2A1A',
    heroHtml
  );
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="${GOLD_LT}" style="padding:20px 24px;border:1px solid ${GOLD};border-radius:4px;text-align:center;">
          ...
          <p style="margin:0;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;color:${MUTED};">Return to mygiftnursemporium.com to complete your payment and lock in this time.</p>
        </td>
      </tr>
    </table>
...
function getBookingConfirmedEmailHtml(booking, user) {
  ...
  const bodyHtml = `
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid ${BORDER};border-left:4px solid ${GOLD};border-radius:0 4px 4px 0;overflow:hidden;">
      <tr bgcolor="${OFFWHITE}">
        <td style="padding:16px 18px;">
          <span style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;font-weight:700;color:${INK};display:block;margin-bottom:4px;">MyGiftNurs Studio</span>
...
function getOrderStatusEmailHtml(order, user) {
  ...
  return layout(
    ...
    `Your MyGiftNurs order #${order._id} is now ${cfg.label.toLowerCase()}.`,
    bodyHtml,
    cfg.heroBg,
    heroHtml
  );
